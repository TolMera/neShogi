var engine = {
	...
	placePieces() {
		...
		this.board.position[65] = this.pieces.black.rook[0];
		this.pieces.black.rook[0].position = 65;
		this.board.position[71] = this.pieces.black.bishop[0];
		...
		this.board.position[17] = this.pieces.white.rook[0];
		this.pieces.white.rook[0].position = 17;
		this.board.position[11] = this.pieces.white.bishop[0];
